...
public class PolymarketClient : IPredictionMarketSource
{
    ...
    // Race ID -> Polymarket market ID (the "Democrat" side of each 2026 general-election winner
    // market). Generated by the ElectionForecaster.MarketDiscovery tool against the Gamma API —
    // re-run it to refresh: `dotnet run --project ElectionForecaster.MarketDiscovery`. Do not
    // hand-edit except for the three Alaska/California races, which are top-four / top-two contests
    // (not a clean D-vs-R market) and are kept hand-picked below.
    private static readonly Dictionary<string, string> RaceIdToMarketId = new()
    {
        ...
        { "WV-SEN-2026", "630989" },
        { "WY-SEN-2026", "631002" },
        { "AK-SEN-2026", "634974" }, // top-four jungle primary — not a two-party market
        ...
        { "WI-GOV-2026", "629720" },
        { "WY-GOV-2026", "629733" },
        { "AK-GOV-2026", "635012" }, // not a clean two-party market
        { "CA-GOV-2026", "628954" }, // top-two — may be D vs D
    };
