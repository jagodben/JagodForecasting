  ...
  <div>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
      <div style={{ flex: 1, textAlign: 'center' }}>
        <div style={{ fontSize: '38px', fontWeight: 600, color: '#1a1a1a' }}>{(headDem * 100).toFixed(1)}%</div>
      </div>
      ...
      <div style={{ flex: 1, textAlign: 'center' }}>
        <div style={{ fontSize: '38px', fontWeight: 600, color: '#1a1a1a' }}>{(headRep * 100).toFixed(1)}%</div>
      </div>
    </div>
    {forecast && (
      ...
      {avg && (
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '28px', fontWeight: 600, color: '#1a1a1a' }}>{avg.demPercent.toFixed(1)}%</div>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '28px', fontWeight: 600, color: '#1a1a1a' }}>{avg.repPercent.toFixed(1)}%</div>
