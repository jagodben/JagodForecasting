...
export const SocialLinks = ({ color = 'currentColor', size = 16, label }: { color?: string; size?: number; label?: string }) => (
  <span style={{ display: 'inline-flex', alignItems: 'center', gap: 10 }}>
    ...
    <a
      ...
      href="https://github.com/jagodben"
      target="_blank"
    ...
    <a
      className="social-link"
      href="https://www.linkedin.com/in/ben-jagod-314061230/"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="LinkedIn"
      style={{ display: 'inline-flex', color }}
