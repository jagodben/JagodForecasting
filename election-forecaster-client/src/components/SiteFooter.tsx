...
// Slim site-wide bottom bar (in normal flow, at the bottom of the page): about/methodology link,
// copyright, a light disclaimer, and (only on the map/home page) the colorblind-pattern switch.
